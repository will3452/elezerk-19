...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
            <div class="container">
                <a class="navbar-brand" href="#page-top"><img src="/assets/img/inline-logo.jpg" alt="..." /></a>
            ...
            <div class="container">
                <div class="text-center">
                    ...
                    <h3 class="section-subheading text-muted">
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Aliquid facilis blanditiis aliquam sequi exercitationem? Magni, ex reiciendis natus deserunt vel itaque eveniet voluptas provident pariatur mollitia sint suscipit iste unde!
                    </h3>
                </div>
            </div>
        </section>
